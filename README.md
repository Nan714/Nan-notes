...
基于 [Quartz](https://quartz.jzhao.xyz/)（v4.5.2）搭建的个人博客，内容来自 Obsidian 笔记库 `knowledge/cs`。
...
去 GitHub 新建一个仓库（比如叫 `tuzhong-notes`），**不要**勾选 "Add a README file"，保持空仓库。
...
git branch -M main
git remote add origin https://github.com/你的用户名/tuzhong-notes.git
...
网址是：`https://你的用户名.github.io/tuzhong-notes/`
...
```ts
baseUrl: "yourname.github.io/tuzhong-notes",
```
